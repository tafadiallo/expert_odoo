    ...
    def create(self, vals):
        ...
        if duration_expected_heure <= 8.0:
            ...
            if duration_expected_heure<=5 and heure_date_depart in ['8','9','10','11','12']:                   
                ...
                date_fin_planification = date_str_01+f" {heure_fin}:00:00"
            ...
            if duration_expected_heure>5 and heure_date_depart in ['8','9','10','11','12']:                   
                ...
                date_fin_planification_04= date_str_02+f" {heure_planification_fin_04}:00:00"
                self.env['mrp.workorder'].create({
            ...
            if duration_expected_heure>3 and heure_date_depart in ['14','15','16']:
                ...
                date_debut_apres_17=date_str+f" 8:00:00"
                heure_fin_ap_17h=8+(duration_expected_heure-5)
                date_fin_apres_17=date_str+f" {heure_fin_ap_17h}:00:00"
                nom_01=res.name+'Avant_HPause'
                self.env['mrp.workorder'].create({
